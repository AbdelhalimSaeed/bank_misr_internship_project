...
let newProduct = ProductInfo(context: context)
   ...
   newProduct2.boughtItemsCount = 1
   ...
   newProduct3.boughtItemsCount = 1
   ...
   newProduct4.boughtItemsCount = 1
   ...
   newProduct5.boughtItemsCount = 1
   ...
   newProduct6.boughtItemsCount = 1
   ...
   newProduct7.boughtItemsCount = 1
   ...
   newProduct8.boughtItemsCount = 1
